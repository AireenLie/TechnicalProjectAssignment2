...
const searchBar = document.getElementById('search-movies')
let filtergalery= []
filtergalery=movies
...
searchBar.addEventListener('keyup',(e)=>{
  ...
  let filterSomething= getMovies(searchFilm)
...
//         <img src="https://image.tmdb.org/t/p/w500/spCAxD99U1A6jsiePFoqdEcY0dG.jpg" class="card-img-top" alt="movie.jpg">
//            <div class="card-body">
...
//                <strong>Rating: 7.4</strong>
//             </div>
//       </div>
//       <p class="card-text" style="text-align:justify;"> For best friends Becky and Hunter, life is all about conquering fears
//          and pushing limits. But after they climb 2,000 feet to the top of a remote, abandoned 
//          radio tower, they find themselves stranded with no way down. Now Becky and Hunter's expert
//           climbing skills will be put to the ultimate test as they desperately fight to survive the 
//           elements, a lack of supplies, and vertigo-inducing heights.
//        </p>
//     </div>
//  <div class="card-footer">
//       <small class="text-muted">Release date : 2022-08-11</small>
//   </div>
// </div>
// </div>
...
let dataMovies= keyword
  ...
  dataMovies.forEach(property => {
    contentData += `
    <div class="col" id='list-movies'> 
    <div class="card h-100">
      <img src="${property.poster_path}" class="card-img-top" alt="${property.title}" >
      <div class="card-body">
      <div class"card-body-first" style="display:flex ;flex-direction:row;">
                     <div class="col align-self-start"> 
               ...
               <p class="card-text" style="text-align:justify;"> ${property.overview}
               </p>
             </div>
          <div class="card-footer">
              <small class="text-muted">Release date : ${property.release_date}</small>
            </div>
         </div>
     </div>
